...
Renderer::Renderer(Game* game, XMFLOAT3 backColor)
	...
	, m_indexBufferView{}
{
	m_vertices[0] = { -0.525f, -0.7f, 0.0f };
	m_vertices[1] = { -0.525f,  0.7f, 0.0f };
	m_vertices[2] = {  0.525f, -0.7f, 0.0f };
	m_vertices[3] = {  0.525f,  0.7f, 0.0f };
